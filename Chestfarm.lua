        ...
        if AllowRunService == true then
            if highChestOnly == false then
                ...
                if not game.Players.LocalPlayer.Character then
                    ...
                    if hasHumanoid then
                        local Chest = game.Workspace:FindFirstChild("Chest3") or game.Workspace:FindFirstChild("Chest2") or game.Workspace:FindFirstChild("Chest1") or game.Workspace:FindFirstChild("Chest1") or game.Workspace:FindFirstChild("Chest")
            ...
            elseif highChestOnly == true then
                ...
                if not game.Players.LocalPlayer.Character then
                    ...
                    local hasHumanoid = game.Players.LocalPlayer.Character:FindFirstChild("Humanoid")
                    if hasHumanoid then
                        local Chest = game.Workspace:FindFirstChild("Chest3") or game.Workspace:FindFirstChild("Chest2") or game.Workspace:FindFirstChild("Chest1")
