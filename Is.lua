...
ImageButton.Image = "rbxassetid://17576103507"
...
Tabs.Main:AddButton({
        Title = "Hutao Hub Discord Server",
...
local ToggleKillPlayerTrial = Tabs.Race:AddToggle("ToggleKillPlayerTrial", {Title = "Auto kill player after trial",Description = "", Default = false })
...
Fluent:Notify({
    Title = "Hutao Hub",
    Content = "Thanks For Using Hutao Hub",
    Duration = 8
})
